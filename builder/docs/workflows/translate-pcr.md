...
Translate human-facing headings, table labels, process names, explanatory notes, and ordinary prose. Preserve machine-facing identifiers and controlled values, including `process_id`, `amount_kind`, `basis_kind`, `evidence_kind`, `source_ids`, Tiangong UUIDs, and source ids.
